...
export default function OperationsTeam({allOpsData}) {
	return <section id="operations" className="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 justify-items-center max-w-5xl mx-auto gap-8">
		<div className="pt-32">
