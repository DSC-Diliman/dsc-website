    ...
    <>
      <Head>
        <title>{title ? `${title} | GDSC UPD` : "GDSC UP Diliman"}</title>
				<meta name="description" content="Website for the Google Developer Student Clubs - UP Diliman chapter." />
				<meta name="keywords" content="Google Developer Student Clubs, GDSC, UP Diliman" />
