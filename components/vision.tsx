      ...
      <div className="grid sm:grid-cols-2 max-w-3xl mx-auto gap-4 md:gap-12">
        <div className="hidden sm:block">
          <AnimatedObject
            ...
            scrub={true}
          >
            <Image src="/images/vision-1.png" alt="Vision image 1" fill />
          </AnimatedObject>
          <div
            className="div-style1 img-frame w-64 h-52"
            style={{ position: "relative" }}
          >
            <Image src="/images/vision-2.png" alt="Vision image 2" fill />
          </div>
        ...
        <div>
          <h1 className="mb-4 sm:mt-28 text-2xl text-red-700 font-black">
            VISION
          </h1>
          ...
          <AnimatedObject
            ...
            scrub={true}
          >
            <Image src="/images/vision-3.png" alt="Vision image 3" fill />
          </AnimatedObject>
        </div>
      </div>
    </section>
