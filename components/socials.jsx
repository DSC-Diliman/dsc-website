...
export default function Socials() {
	return (
		<section id="reach" className="relative px-10 py-10">
			<div className="mx-auto max-w-max grid grid-cols-2 lg:grid-cols-3 gap-8">
				<div className="col-span-1 lg:col-span-2 relative flex flex-col justify-center">
					<ParallaxObject className="absolute -left-6 w-20 h-20 bg-yellow-300 rounded-full" y={[0, 200]} />
					<ParallaxObject className="absolute left-12 w-10 h-10 bg-blue-300 rounded-full" y={[200, 400]} />
					<ParallaxObject className="absolute left-36 w-10 h-10 bg-red-300 rounded-full" y={[0, 100]} />
