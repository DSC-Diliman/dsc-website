...
export default function Portrait({
  ...
  return (
    <div
      className={`img-frame group relative flex h-40 w-32 flex-col justify-end overflow-hidden rounded-3xl text-sm shadow-2xl sm:h-52 sm:w-40 md:h-60 md:w-48 ${className}`}
    >
      <Image
        src={src}
        alt="Member image"
